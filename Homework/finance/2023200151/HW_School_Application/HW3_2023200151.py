...
def generate_application_letters():
    ...
    try:
        # 读取Excel数据
        df_universities = pd.read_excel(r"C:\Users\陈\Desktop\HW3\HW3_2023200151.xlsx", sheet_name='Institution')
        df_research_areas = pd.read_excel(r"C:\Users\陈\Desktop\HW3\HW3_2023200151.xlsx", sheet_name='Person')
        ...
        # 加载模板
        doc = DocxTemplate(r"C:\Users\陈\Desktop\HW3\HW3_2023200151.docx")
        print("模板加载成功")
